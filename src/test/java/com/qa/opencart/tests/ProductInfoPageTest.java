...
public class ProductInfoPageTest extends BaseTest {
	...
	{
	return	ExcelUtil.getTestData(Appcontants.PRODUCT_IMAGES_COUNT);
	}
	@Test(dataProvider = "getProductImagesSheetData")
		...
		public void productImagesCountTest(String searchKey, String productName, String imagesCount) {
			...
			productInfoPage = searchResultsPage.selectProduct(productName);
			Assert.assertEquals(productInfoPage.getProductImagesCount(), Integer.parseInt(imagesCount), AppErrors.IMAGES_NOT_MISMATCHED);
