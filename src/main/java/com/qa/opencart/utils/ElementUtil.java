...
import com.qa.opencart.ecpections.ElementException;
...
public class ElementUtil {
	...
	@Step("etening value {1} in text field locator: {0} and waiting for element with : {2} secs")
	...
	@Step("etening value {1} in text field locator: {0}")
	...
	@Step("finding the element locator :{0} ")
	...
	@Step("checking state of locator: {0} is displayed or not..")
